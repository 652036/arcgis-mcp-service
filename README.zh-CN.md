...
新增：[GIS 可靠性修复与验收范围](docs/GIS_RELIABILITY.md)，包括显式裁剪模式、完整范围覆盖检查和结果资格门禁。

原生加权叠加 JSON 参数和本机数据 MCR 实测流程见[生态流程验收](docs/ECOLOGICAL_QA.zh-CN.md)。
...
- [GIS 可靠性修复与验收范围](docs/GIS_RELIABILITY.md)
